<template>
  <Layout>
    <section class="px-6 pb-8 text-gray-200 sm:ml-96 sm:px-20">
      <h2 class="pt-8 pb-3 text-2xl sm:text-3xl">About Giusesppe's</h2>
      <p class="py-2 sm:text-2xl">Giuseppe’s Pizzeria & Cocktail bar is located in Gansbaai and we are proud to be considered as one of the best pizzerias in the Western Cape. Our friendly family atmosphere coupled with our delicious menu is a true attraction to locals and tourists alike. We are a family friendly pizzeria and you can find us on the corner of Dirkie Uys and Fabriek streets in Gansbaai.</p>
