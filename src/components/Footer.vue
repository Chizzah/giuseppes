<template>
  <footer class="w-full text-gray-200 bg-black pin-b sm:hidden">
    <div class="pt-8 text-xs fill-current">
      <div class="flex items-center justify-center py-6 mx-4 border-t-2 border-solid">
        ...
        <p class="ml-4">36 Markham Rd, Claremont, Cape Town, 7708</p>
      </div>
      <div class="flex items-center justify-around pb-6 mx-4">
        <div class="flex">
        ...
        <div class="flex">
          ...
          <p class="ml-4">chaddpoggenpoel@gmail.com</p>
        </div>
      </div>
    </div>
    <div class="flex justify-around py-2 mx-12 bg-gray-200 fill-current">
      <a href="#"><g-image class="hover:text-gray-500" src="../../static/icons/facebook.svg" width="13" /></a>
      <a href="#"><g-image src="../../static/icons/twitter.svg" width="25" /></a>
      <a href="#"><g-image src="../../static/icons/instagram.svg" width="20" /></a>
    </div>
    <div class="py-4 mx-4 text-xs text-center">
      <p class="pb-2">JAMstack Website by <a class="font-semibold hover:text-green-400" href="https://chaddwebdesign.co.za/">Chadd Web Design</a></p>
