<template>
    <footer class="w-full pin-b bg-green-800 text-gray-200 pin-b sm:hidden">
        <div class="pt-8 text-xs fill-current">
            ...
            <div class="mx-4 pb-6 flex justify-around items-center">
                <div class="flex">
            ...
            <div class="mx-4 py-6 border-solid border-t-2 flex justify-around">
        ...
        <div class="mx-4 py-4 border-solid border-t-2 text-xs text-center">
