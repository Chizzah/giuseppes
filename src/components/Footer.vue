<template>
    <footer class="block pin-b w-full bg-green-800 text-gray-200 pin-b sm:hidden">
        <div class="pt-8 text-xs fill-current">
            <div class="mx-5 py-6 border-solid border-t-2 flex justify-center items-center">
                ...
                <p class="ml-4">c/o Fabriek & Dirkie Uys street, Gansbaai, Western Cape, South Africa.</p>
            </div>
            <div class="mx-5 pb-6 flex justify-around items-center">
                <div class="flex">
                ...
                <p class="ml-4">ansie@sswifi.co.za</p>
                </div>
            </div>
        </div>
            <div class="mx-5 py-6 border-solid border-t-2 flex justify-around">
        ...
        <div class="mx-5 py-4 border-solid border-t-2 text-xs text-center">
            <p class="pb-2">JAMstack Website by digiCloud</p>
